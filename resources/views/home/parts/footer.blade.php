...
<footer class="footer-green d-lg-none">
  <div class="container py-4">
    ...
    <div class="d-flex align-items-start mb-3">
      ...
      <div>
        <div class="fm-title">Desa Kersik</div>
        <div class="fm-sub">Kecamatan Marang Kayu<br>Kabupaten Kutai Kartanegara<br>Provinsi Kalimantan Timur</div>
      </div>
    </div>
    ...
    <div id="footerAcc">
      ...
      <div id="accContact" class="collapse" data-bs-parent="#footerAcc">
        <ul class="acc-body">
          ...
          <li><a href="mailto:kersik.marangkayu@kukarkab.go.id">kersik.marangkayu@kukarkab.go.id</a></li>
        </ul>
      </div>
    ...
    <div class="row g-4 align-items-start">
      ...
      <div class="col-lg-4">
        <div class="d-flex align-items-start">
          ...
          <div>
            <h3 class="desk-heading mb-2">Pemerintah Desa Kersik</h3>
            <address class="footer-text mb-0">
              Jalan Langaseng Dusun Empang RT.003<br>
              Desa Kersik, Kec. Marang Kayu, Kab. Kutai Kartanegara<br>
              Provinsi Kalimantan Timur, 75385
            </address>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-3">
        ...
        <div class="footer-text mb-2 display-3"><i class="fa fa-phone me-2 footer-link" href="tel:082150208664"> 082150208664</i></div>
        <div class="footer-text mb-3"><i class="fa fa-envelope me-2 footer-link" href="mailto:kersik.marangkayu@kukarkab.go.id"> siskaper.go.id</i></div>
      ...
      <div class="col-lg-3">
        ...
        <ul class="footer-list">
          <li><a class="footer-link" href="tel:082150208664">Jumadi / Kades Kersik</a></li>
          <li><a class="footer-link" href="tel:08xxxxxxxxxx">Yayan / Ambulan Kersik</a></li>
        </ul>
      </div>
      ...
      <div class="col-lg-2">
        ...
        <ul class="footer-list">
          <li><a class="footer-link" href="#">Website Kemendesa</a></li>
          <li><a class="footer-link" href="#">Website Kemendagri</a></li>
          <li><a class="footer-link" href="#">Website Kabupaten Kutai Kartanegara</a></li>
          <li><a class="footer-link" href="#">Cek DPT Online</a></li>
        </ul>
      </div>
    </div>
  </div>
