...
<footer class="footer-green d-lg-none">
  <div class="container py-4">
    ...
    <div class="d-flex align-items-start mb-3">
      ...
      <div>
        <div class="fm-title">Desa Sirih Sekapur Perkembangan</div>
        <div class="fm-sub">Kecamatan Jujuham<br>Kabupaten Bungo<br>Provinsi Jambi</div>
      </div>
    </div>
    ...
    <div id="footerAcc">
      ...
      {{-- Kunjungan Website --}}
      <button class="acc-btn collapsed" data-bs-toggle="collapse" data-bs-target="#accVisit" aria-expanded="false">
        <span class="ico"><i class="fa fa-globe"></i></span>
        <span class="txt">Kunjungan Website</span>
        <span class="chev"><i class="fa fa-chevron-down"></i></span>
      </button>
      <div id="accVisit" class="collapse" data-bs-parent="#footerAcc">
        <ul class="acc-body">
          <li>Hari ini: <b>—</b></li>
          <li>Bulan ini: <b>—</b></li>
          <li>Total: <b>—</b></li>
      ...
      <div id="accImportant" class="collapse" data-bs-parent="#footerAcc">
        <ul class="acc-body">
          <li><a class="footer-link" href="tel:082316032698">Deni / Kades Siskaper</a></li>
          <li><a class="footer-link" href="tel:082316032698">Suhendro / Ambulan Siskaper</a></li>
        </ul>
      </div>
    ...
    <div class="powered text-center mt-3">POWERED BY &copy; <a
        href="https://www.instagram.com/kkn_sirihsekapurperkembangan?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
        class="footer-bar-link">KKN SIRIH SEKAPUR PERKEMBANGAN 2025 UMMUBA.</div>
  </div>
  </footer>
  ...
  <footer class="footer-green d-none d-lg-block">
      ...
      <div class="row g-4 align-items-start">
        ...
        <div class="col-lg-4">
          <div class="d-flex align-items-start">
            <img src="{{ asset('home/img/lambang-Kabupaten-Bungo.png') }}" alt="Lambang" class="footer-logo me-3"
              loading="lazy">
            <div>
              <h3 class="desk-heading mb-2">Pemerintah Desa Siskaper</h3>
              <address class="footer-text mb-0">
                Jalan Datuk Rio hbn, Kampung Tukum Jaya RT.011<br>
                Desa Sirih Sekapur Perkembangan, Kec. Jujuham, Kab. Bungo<br>
        ...
        <div class="col-lg-3">
          ...
          <div class="footer-text mb-2 display-3"><a class="fa fa-phone me-2 footer-link" href="tel:082150208664">
              082150208664</a></div>
          <div class="footer-text mb-3"><a class="fa fa-envelope me-2 footer-link"
              href="mailto:sirihsekapurperkembangan@mail.go.id"> siskaper.go.id</a></div>
    ...
    <div class="footer-bar py-0">
      <div class="container">
        <div class="text-center small fw-semibold">POWERED BY &copy; <a
            href="https://www.instagram.com/kkn_sirihsekapurperkembangan?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
            class="footer-bar-link">KKN SIRIH SEKAPUR PERKEMBANGAN 2025 UMMUBA.</a></div>
      </div>
    </div>
  </footer>
